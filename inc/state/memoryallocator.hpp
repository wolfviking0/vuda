...
namespace detail {
    ...
    public:
        // allocate
        memory_block(const vk::DeviceMemory memory, const vk::DeviceSize offset, const vk::DeviceSize size, const vk::Buffer& buffer)
            : m_memory(memory)
            , m_offset(offset)
            , m_size(size)
            , m_ptr(nullptr)
        ...
        */
            ...
            , m_defaultChunkSize(default_alloc_size)
        {
            ...
            */
            ...
            memoryTypeIndex = deviceMemProperties.FindMemoryTypeFromCandidates(device, std::vector<vk::MemoryPropertyFlags> { vk::MemoryPropertyFlagBits::eDeviceLocal }, candidate);
            ...
            memoryTypeIndex = deviceMemProperties.FindMemoryTypeFromCandidates(device, std::vector<vk::MemoryPropertyFlags> { vk::MemoryPropertyFlagBits::eHostVisible | vk::MemoryPropertyFlagBits::eHostCoherent }, candidate);
